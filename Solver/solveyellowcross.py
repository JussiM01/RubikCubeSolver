...
top_cross = [(0, 0, 10), (0, 9, 10), (-9, 0, 10), (0, -9, 10), (9, 0, 10)]
...
def yellow_cross(cube): return {cube[p] for p in top_cross} == {'y'}
...
def yellow_center(cube): return cube[(0, 0, 10)] == 'y'

bl_rot = ['F', 'U', 'R', 'Ui', 'Ri', 'Fi']
br_rot = ['L', 'U', 'F', 'Ui', 'Fi', 'Li']
fr_rot = ['B', 'U', 'L', 'Ui', 'Li', 'Bi']
...
yellow_paterns = [yellow_angle_back_left, yellow_angle_back_right,
    ...
    yellow_line_vertical, yellow_center]
